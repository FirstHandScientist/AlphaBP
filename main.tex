...
\begin{figure}
  \begin{centering}
    \begin{tikzpicture}
      ...
      \node[cnode] (pajk) at (3, 1.5) {$\Nn(t)\backslash t$};
      \node[cnode] (paik) at (-3, 1.5) {$\Nn(s)\backslash s$};

      \node[nnode] (tk) at (0, 1.5) {$\phi_{st}(x_s, x_t)$};
      \node[enode] (xi) at (-1.5 ,0) {$x_v$};
      \node[nnode] (fi) at (-1.5 , -1.5) {$\phi_s(x_s)$};

      \node[enode] (xj) at (1.5 ,0) {$x_u$};
      \node[nnode] (fj) at (1.5 , -1.5) {$\phi_s(x_s)$};
      % connections
...
\begin{figure}[!ht]
  \begin{centering}
    \begin{tikzpicture}
      ...
      \node[cnode] (paik) at (0, 1.5) {$\Nn(v)$};

      \node[enode] (xi) at (0 ,0) {$x_v$};
