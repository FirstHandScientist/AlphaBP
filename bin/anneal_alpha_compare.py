...
import sys
sys.path.append("./src")
from modules import MMSE, AlphaBP, MMSEalphaBP, ML, LoopyBP, AnnealAlphaBP
...
class hparam(object):
    ...
    algos = {"MMSE": {"detector": MMSE, "legend": "MMSE"},
             ...
             "AnnealAlphaBP, 1-0.5": {"detector": AnnealAlphaBP, \
                                      "alpha": [1.0, 0.5], \
                                      "anneal_rate": 0.9, \
                                      "legend":r'$\alpha$-BP, 1->0.5'},
             "AnnealAlphaBP, 0.5-1": {"detector": AnnealAlphaBP, \
                                      "alpha": [0.5, 1], \
                                      "anneal_rate": 1.1, \
                                      "legend":r'$\alpha$-BP, 0.5->1'},
...
if __name__ == "__main__":
    ...
    with open("figures/anneal_alpha_compare.pkl", 'wb') as handle:
    ...
    ax.grid()
    fig.savefig("figures/anneal_alpha_compare.pdf")
    #plt.show()
